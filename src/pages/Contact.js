                ...
                <Layout>
                    ...
                    >
                        ...
                        >
                            ...
                            <Table dataSource={allUser} rowKey='ID'>
                                <Column title="ลำดับ" dataIndex="ID" key="ID" />
                                <Column title="ชื่อ-สกุล" dataIndex="customer_name" key="customer_name" />
                                <Column title="ทะเบียน" dataIndex="license_plate" key="license_plate" />
                                <Column title="เรท" dataIndex="rate" key="rate" />
                                <Column title="ยอดกู้" dataIndex="loan_amount" key="loan_amount" />
                                <Column title="วันที่เสนอ" dataIndex="date_submission" key="date_submission" />
                                <Column title="วันที่รับ" dataIndex="date_received" key="date_received" />
                                <Column title="ระยะเวลา" dataIndex="time" key="time" />
                                <Column title="สถานะ" dataIndex="status" key="status" />
                                <Column title="Action" key="action"
                                    render={(_, record) => (
                                        <Space size="middle">
                                            <a onClick={() => { onUserDelete(allUser.id) }} >Delete</a>
                                        </Space>
                                    )}
                                />
                            </Table>
